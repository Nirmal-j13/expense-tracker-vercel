...
const HomePage = () => {
  return (
    <>
     <Navbar/>
     <div class="h-14 bg-gradient-to-r from-green-500 to-blue-500">
     <p class="text-lg md:text-xl text-center ... font-bold">Chat with BankyBot</p>
     <div class="flex justify-center">
     <span class="relative flex h-3 w-3">
  <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-yellow-200 opacity-15"></span>
  <span class="relative inline-flex rounded-full h-3 w-3 bg-sky-900">
  </span>
</span>
<div style={{backgroundImage:`url (${chatbot})`}}></div>
<Link
          to="/BankyBot"
          className="bg-gradient-to-r from-blue-500 to-green-500 text-white hover:bg-blue-400 font-bold py-2 px-4 mt-3 rounded items-center "
                    >
         BankyBot
                    </Link>
  </div>
